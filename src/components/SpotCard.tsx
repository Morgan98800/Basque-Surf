...
export const SpotCard: React.FC<SpotCardProps> = ({
  ...
  return (
    <div
      ...
      className="bg-nautical-850 hover:bg-nautical-800 border border-nautical-750 active:border-sky-600/60 rounded-xl p-3.5 sm:p-4 transition cursor-pointer active:scale-[0.99] flex flex-col justify-between"
    >
      <div>
        {/* Top bar: City & Type + Favorite */}
        <div className="flex items-center justify-between gap-2 mb-2">
          <div className="flex items-center space-x-1.5 text-[11px] text-slate-400 uppercase tracking-wider font-semibold truncate">
            {isTop && (
              <span className="flex items-center gap-1 text-emerald-400 bg-emerald-950/80 border border-emerald-800/80 px-1.5 py-0.2 rounded text-[10px] font-bold shrink-0">
        ...
        <div className="flex items-start justify-between gap-3 mb-2">
          ...
          {/* Note sur 10 */}
          <div className={`shrink-0 flex items-center gap-1 px-2.5 py-1 rounded-lg border font-mono ${badge.bg}`}>
        ...
        {score.warning && (
          <div className="mb-2 p-2 rounded-lg bg-rose-950/60 border border-rose-800 text-rose-300 text-[11px] flex items-start gap-1.5">
